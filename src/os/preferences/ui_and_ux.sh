...
execute "sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string 'King' && \
         sudo scutil --set ComputerName 'king' && \
         sudo scutil --set HostName 'king' && \
         sudo scutil --set LocalHostName 'king'" \
    "Set computer name"
